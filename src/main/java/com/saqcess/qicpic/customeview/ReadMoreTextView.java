...
public class ReadMoreTextView extends TypeTextView {
    ...
    public void setReadMoreTextViewListener (ReadMoreTextViewListener readMoreTextViewListener) {
        this.readMoreTextViewListener = readMoreTextViewListener;
    }
    ...
    public interface ReadMoreTextViewListener {
        void onReadMoreChange(ReadMoreTextView textView);
    }
    ...
    private class ReadMoreClickableSpan extends ClickableSpan {
        ...
        public void onClick (View widget) {
            readMore = !readMore;
            setText();
            if (readMoreTextViewListener != null) {
                readMoreTextViewListener.onReadMoreChange(ReadMoreTextView.this);
            }
        }
