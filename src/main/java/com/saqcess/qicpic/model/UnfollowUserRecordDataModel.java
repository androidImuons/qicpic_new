...
public class UnfollowUserRecordDataModel {
    @SerializedName("id")
    @Expose
    private Integer id;
    ...
    @Expose
    private List<PostUserDataData> postData = null;
    ...
    public List<PostUserDataData> getPostDat() {
        return postData;
    }

    public void setPostData(List<PostUserDataData> postData) {
