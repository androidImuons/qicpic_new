...
public class PostRecycleViewAdapter extends AppBaseRecycleAdapter{
    ...
    PostViewInterface listener;
    private String tag = "PostRecycleViewAdapter";
    private boolean is_like;

    public PostRecycleViewAdapter(Context applicationContext, List<GetPostRecordModel> post, PostViewInterface listener) {
    ...
    public class StoryUserListView extends BaseRecycleAdapter.BaseViewHolder implements ReadMoreTextView.ReadMoreTextViewListener {
       ...
       // ProgressBar pb_image;
        ...
        public void setData(int index) {
           ...
           // listener.loadImage(context, iv_user_image, pb_image, model.getUser().getProfile_picture(), R.drawable.ic_profile);
            Glide.with(context)
        ...
        private void setClick(int pos) {
            ...
            iv_heart.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if ((Integer) view.getTag() == 0) {
                        iv_heart.setTag(1);
                        listener.clickLike(pos, "like");
                        iv_heart.setBackgroundResource(R.drawable.ic_heart_fill);
                    } else {
                        iv_heart.setTag(0);
                        listener.clickLike(pos, "unlike");
                        iv_heart.setBackgroundResource(R.drawable.ic_heart);
                    }
                }
            });
            iv_commit.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    listener.clickComment(pos);
                }
            });
            iv_share.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    listener.sendPost(pos);
                }
            });
            iv_tag.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    listener.savePOST(pos);
                }
            });
            iv_more.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    listener.moreaction(postDataModelList.get(pos));
                }
            });
    ...
    public interface PostViewInterface {
        ...
        void moreaction(GetPostRecordModel getPostRecordModel);
