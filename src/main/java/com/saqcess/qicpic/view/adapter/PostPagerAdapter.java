...
public class PostPagerAdapter extends PagerAdapter {
    ...
    public PostPagerAdapter(Context context, List<PostGalleryPathModel> postGalleryPath, PostRecycleViewAdapter postRecycleViewAdapter) {
...
//                    .into(viewHolder.iv_post_image);
           // context.loadImage(context, (CircleImageView) viewHolder.iv_post_image,viewHolder.pb_bar,postGalleryPathModel.getPath(),R.mipmap.ic_logo);
            Glide.with(context)
                    .load( postGalleryPathModel.getPath())
