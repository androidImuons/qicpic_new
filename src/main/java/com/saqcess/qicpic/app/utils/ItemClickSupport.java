...
public class ItemClickSupport {
    ...
    public static ItemClickSupport getFrom(View view) {
        if (view == null || view.getParent() == null || !(view.getParent() instanceof RecyclerView)) {
            return null;
        } else {
            return (ItemClickSupport) ((RecyclerView) view.getParent()).getTag(R.id.item_click_support);
        }
    ...
    public OnItemClickListener getmOnItemClickListener(OnItemClickListener onItemClickListener) {
